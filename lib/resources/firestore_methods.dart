...
import 'package:streamingapp/models/models.dart';
...
class FirestoreMethods {
  ...
  //Provides the action to start the broadcast
  ...
  //Send the chat-log data to firebase
  ...
  //Shows us: How many users saw the stream from start to end?
  ...
  //Provides end live action for stream to streamer
